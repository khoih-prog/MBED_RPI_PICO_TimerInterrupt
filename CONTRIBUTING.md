## Contributing to MBED_RPI_PICO_TimerInterrupt
...
```
xy@xy-Inspiron-3593:~$ cd Arduino/xy/MBED_RPI_PICO_TimerInterrupt_GitHub/
xy@xy-Inspiron-3593:~/Arduino/xy/MBED_RPI_PICO_TimerInterrupt_GitHub$
```

2. Issue astyle command

```
xy@xy-Inspiron-3593:~/Arduino/xy/MBED_RPI_PICO_TimerInterrupt_GitHub$ bash utils/restyle.sh
```
